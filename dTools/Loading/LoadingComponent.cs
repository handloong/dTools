...
namespace dTools
{
    ...
    */
    [ToolboxBitmap(typeof(LoadingComponent))]
    public class LoadingComponent : System.Windows.Forms.Control
    {
        ...
        public LoadingComponent(int Alpha, bool IsShowLoadingImage)
        {
            ...
            if (IsShowLoadingImage)
            {
                ...
                pictureBox_Loading.Image = dTools.Properties.Resource.loading;
         ...
         */
        [Category("LoadingComponent"), Description("是否使用透明,默认为True")]
        ...
        [Category("LoadingComponent"), Description("设置透明度")]
        public int Alpha
        {
            get
            {
