...
namespace dTools
{
   /// <summary>
    ...
    public class IDCardHelper
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static List<IDCardAreaEntity> GetIDCardAreaList()
        {
            #region 地区字符串
            string str = $@"110000,北京市
110100,北京市市辖区
110101,北京市东城区
110102,北京市西城区
110103,北京市崇文区
...
659001,新疆维吾尔族自治区石河子市";
            #endregion
            List<IDCardAreaEntity> iDCardAreaEntities = new List<IDCardAreaEntity>();
            var list = str.Split('\n');
            list.ToList().ForEach(x =>
            {
                var t = x.Split(',');
                IDCardAreaEntity iDCardAreaEntity = new IDCardAreaEntity()
                {
                    AreaCode = t[0],
                    AreaName = t[1]
                };
                iDCardAreaEntities.Add(iDCardAreaEntity);
            });
            return iDCardAreaEntities;
        }

        /// <summary>
        /// 生成身份证号码
        /// </summary>
        /// <param name="areacode">地区编号,如不知道请调用本类下的GetIDCardAreaList获取</param>
        /// <param name="birthformat">有效生日yyyymmdd格式，例如:20180214</param>
        /// <param name="sex">性别 随机:-1 男:0 女:1 </param>
        /// <returns></returns>
        public static string CreateIDCard(string areacode = "", string birthformat = "", int sex = -1)
        {
            int ryear = Convert.ToInt32(DateTime.Now.Year.ToString()) - 19.GetRandomNumber(26);
            int rmonth = 1.GetRandomNumber(12);
            int rday = 1.GetRandomNumber(dayOfYearMonth(ryear, rmonth));
            var birthText = birthformat == "" ? ryear + rmonth.ToString("D2") + rday.ToString("D2") : birthformat;
            var placeCode = areacode == "" ? placesIdList[0.GetRandomNumber(0, placesIdList.Length)].ToString() : areacode;
            var generatedIdNumber = new StringBuilder();
            generatedIdNumber.Append(placeCode).Append(birthText);
            int rdidNum = 0.GetRandomNumber(501) * 2;
            if (sex != -1)
                rdidNum += sex;
            generatedIdNumber.Append(rdidNum.ToString("D3"));
            char checkChr = getCheckChar(generatedIdNumber.ToString());
            return generatedIdNumber.Append(checkChr).ToString();
        }
        ...
        {
            var xValues = getInformationsInIdNumber(idcard);
        ...
        /// <returns></returns>
        public static bool CheckIDCardIsValid(string idcard)
        {
            if (idcard.Length != 18)
            {
                return false;
            ...
            {
                return idcard[17] == getCheckChar(idcard);
            }
            return false;
        }
        #region 私有方法

        private static char getCheckChar(string idNumString)
        {
        ...
        private static string getNumberPlace(string idNumString)
        {
        ...
        private static int dayOfYearMonth(int year, int month)
        {
            if (month < 1 || month > 12)
                return 0;
        ...
        private static string[] getInformationsInIdNumber(string idNumString)
        {
            ...
            return new[] {
                ...
                CheckIDCardIsValid(idNumString) ? "有效号码" : "无效号码"
            };
        }

        private static readonly int[] placesIdList = {
            110000,
            110100,
            110101,
            110102,
        ...
        private static readonly string[] placesList = {
            "北京市",
            "北京市市辖区",
            "北京市东城区",
            "北京市西城区",
            ...
            "新疆维吾尔族自治区哈密地区",
            "新疆维吾尔族自治区哈密地区哈密市",
            "新疆维吾尔族自治区哈密地区巴里坤哈萨克自治县",
            "新疆维吾尔族自治区哈密地区伊吾县",
            "新疆维吾尔族自治区昌吉回族自治州",
            "新疆维吾尔族自治区昌吉回族自治州昌吉市",
            "新疆维吾尔族自治区昌吉回族自治州阜康市",
            "新疆维吾尔族自治区昌吉回族自治州米泉市",
            "新疆维吾尔族自治区昌吉回族自治州呼图壁县",
            "新疆维吾尔族自治区昌吉回族自治州玛纳斯县",
            "新疆维吾尔族自治区昌吉回族自治州奇台县",
            "新疆维吾尔族自治区昌吉回族自治州吉木萨尔县",
            "新疆维吾尔族自治区昌吉回族自治州木垒哈萨克自治县",
            "新疆维吾尔族自治区博尔塔拉蒙古自治州",
            "新疆维吾尔族自治区博尔塔拉蒙古自治州博乐市",
            "新疆维吾尔族自治区博尔塔拉蒙古自治州精河县",
            "新疆维吾尔族自治区博尔塔拉蒙古自治州温泉县",
            "新疆维吾尔族自治区巴音郭楞蒙古自治州",
            "新疆维吾尔族自治区巴音郭楞蒙古自治州库尔勒市",
            "新疆维吾尔族自治区巴音郭楞蒙古自治州轮台县",
            "新疆维吾尔族自治区巴音郭楞蒙古自治州尉犁县",
            "新疆维吾尔族自治区巴音郭楞蒙古自治州若羌县",
            "新疆维吾尔族自治区巴音郭楞蒙古自治州且末县",
            "新疆维吾尔族自治区巴音郭楞蒙古自治州焉耆回族自治县",
            "新疆维吾尔族自治区巴音郭楞蒙古自治州和静县",
            "新疆维吾尔族自治区巴音郭楞蒙古自治州和硕县",
            "新疆维吾尔族自治区巴音郭楞蒙古自治州博湖县",
            "新疆维吾尔族自治区阿克苏地区",
            "新疆维吾尔族自治区阿克苏地区阿克苏市",
            "新疆维吾尔族自治区阿克苏地区温宿县",
            "新疆维吾尔族自治区阿克苏地区库车县",
            ...
            "新疆维吾尔族自治区阿克苏地区阿瓦提县",
            "新疆维吾尔族自治区阿克苏地区柯坪县",
            "新疆维吾尔族自治区克孜勒苏柯尔克孜自治州",
            "新疆维吾尔族自治区克孜勒苏柯尔克孜自治州阿图什市",
            "新疆维吾尔族自治区克孜勒苏柯尔克孜自治州阿克陶县",
            "新疆维吾尔族自治区克孜勒苏柯尔克孜自治州阿合奇县",
            "新疆维吾尔族自治区克孜勒苏柯尔克孜自治州乌恰县",
            "新疆维吾尔族自治区喀什地区",
            "新疆维吾尔族自治区喀什地区喀什市",
            "新疆维吾尔族自治区喀什地区疏附县",
            "新疆维吾尔族自治区喀什地区疏勒县",
            ...
            "新疆维吾尔族自治区和田地区民丰县",
            "新疆维吾尔族自治区伊犁哈萨克自治州",
            "新疆维吾尔族自治区伊犁哈萨克自治州奎屯市",
            "新疆维吾尔族自治区伊犁哈萨克自治州伊犁地区",
            "新疆维吾尔族自治区伊犁哈萨克自治州伊宁市",
            "新疆维吾尔族自治区伊犁哈萨克自治州伊宁县",
            "新疆维吾尔族自治区伊犁哈萨克自治州察布查尔锡伯自治县",
            "新疆维吾尔族自治区伊犁哈萨克自治州霍城县",
            "新疆维吾尔族自治区伊犁哈萨克自治州巩留县",
            "新疆维吾尔族自治区伊犁哈萨克自治州新源县",
            "新疆维吾尔族自治区伊犁哈萨克自治州昭苏县",
            "新疆维吾尔族自治区伊犁哈萨克自治州特克斯县",
            "新疆维吾尔族自治区伊犁哈萨克自治州尼勒克县",
            "新疆维吾尔族自治区塔城地区",
            "新疆维吾尔族自治区塔城地区塔城市",
            "新疆维吾尔族自治区塔城地区乌苏市",
            "新疆维吾尔族自治区塔城地区额敏县",
        ...
        private static readonly int[] numberWeighingList = {
            7,
            9,
            10,
            5,
        ...
        private const string lastNumberIndex = "10X98765432";
        #endregion
    }
    /// <summary>
    /// 身份证地区实体
    /// </summary>
    public class IDCardAreaEntity
    {
        /// <summary>
        /// 地区编码
        /// </summary>
