   ...
   public class INIHelper
    {
        ...
        public static void Write(string Section, string Key, string Value, string iniFilePath)
        {
        ...
        public static string Read(string Section, string Key, string iniFilePath)
        {
